...
const PaymentExpired = ({ error }: { error?: string }) => {
    ...
    <>
      <div className=" bg-[#F8F9FC] flex flex-col items-center justify-center gap-5 pt-6 pb-9">
        ...
        <div className="flex flex-col gap-[6px] text-center max-w-[406px]">
          <h6 className="text-[#1D2939] text-3xl font-bold">
      ...
      <div className="p-5 flex flex-col gap-4">
        <Button
          onClick={() => window.open("https://discord.gg/TyV6UwCD", "_blank")}
        >
          Report a Bug
        </Button>
        <Button variant="ghost" onClick={() => stepperContext.prev()}>
          Try again
        </Button>
      </div>
    </>
